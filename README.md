...
A Python-based end-to-end encrypted chat application built to understand how secure messaging works internally. This project uses X25519 key exchange, HKDF key derivation, ChaCha20-Poly1305 authenticated encryption, replay protection, TTL validation, and lightweight key ratcheting.
